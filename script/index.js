class Validator {
  ...
  //inicia validação de todos os campos
  validate(form) {
  ...
  emailvalidate(input) {
    ...
    let errorMessage = `Insira um e-mail padrão válido`;
  ...
  onlyletters(input) {
    ...
    if (!re.test(inputValue)) {
      this.print < essage(input, errorMessage);
    }
  }
  ...
  passwordvalidate(input) {
    ...
    if(uppercases === 0 || numbers === 0){
        ...
        tis.printMessage(input, errorMessage);
    }
  }
